...
var BLOCKS = {
  ...
  house4:    {cat:'r', icon:'🏡', bh:36, hidden:true, name:{ja:'家4',    en:'House 4',     zh:'房屋4', ko:'집4'}},
  house5:    {cat:'r', icon:'🏡', bh:44, hidden:true, name:{ja:'家5',    en:'House 5',     zh:'房屋5', ko:'집5'}},
  ...
  church2:   {cat:'r', icon:'⛪', bh:56, hidden:true, name:{ja:'教会2',  en:'Church 2',    zh:'教堂2', ko:'교회2'}},
  church3:   {cat:'r', icon:'⛪', bh:66, hidden:true, name:{ja:'教会3',  en:'Church 3',    zh:'教堂3', ko:'교회3'}},
  ...
  park3:     {cat:'p', icon:'🌳', bh:24, hidden:true, name:{ja:'公園3',  en:'Park 3',      zh:'公园3', ko:'공원3'}},
  ...
  museum2:   {cat:'p', icon:'🏛', bh:56, hidden:true, name:{ja:'博物館2', en:'Museum 2',   zh:'博物馆2', ko:'박물관2'}},
  museum3:   {cat:'p', icon:'🏛', bh:64, hidden:true, name:{ja:'博物館3', en:'Museum 3',   zh:'博物馆3', ko:'박물관3'}},
  ...
  bridge2:   {cat:'d', icon:'🌉', bh:16, road:1, bridge:1, hidden:true, name:{ja:'橋2',   en:'Bridge 2',  zh:'桥2',   ko:'다리2'}},
  ...
  port2:     {cat:'d', icon:'⚓',  bh:36, hidden:true, name:{ja:'港2',  en:'Port 2',       zh:'港口2',  ko:'항구2'}},
  port3:     {cat:'d', icon:'⚓',  bh:44, hidden:true, name:{ja:'港3',  en:'Port 3',       zh:'港口3',  ko:'항구3'}},
